...
if __name__ == '__main__':
    print(summarize("Hey, do you have Betty's number? Lemme check . <file_gif> . Sorry, can't find it . Ask Larry .He called her last time we were at the park together .  I don't know him well . <file_gif> . Don't be shy, he's very nice . If you say so . I'd rather you texted him . Just text him . Hannah: Urgh.. Alright . Bye.  Bye bye ."))
